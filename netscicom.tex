...
\caption{CDF p value of KS statistics. It shows that across our entire set of Bittorrent snapshots, around $45\%$ of the time a power-law distribution is not a good fit for the data. Inset figure shows CDF p value for each torrent. The dash line on p value = 0.1 is the threshold.} 
\label{fig:cdf-p}
\vspace{-2mm}
\end{figure}
...
We divide the figure into four areas: area 1, area 2, area 3, and area 4  with green lines as borders.
