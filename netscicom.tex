...
\caption{CDF plot of number of peers for every swarm during measurement with check data x to y time samples for each torrent. It  clearly shows high variation number of peers in every swarm due to churn in Bittorrent networks.} 
\label{fig:num_peers}
\vspace{-2mm}
\end{figure}
