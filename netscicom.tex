...
Although these were top 35 TV series torrent, almost all of these torrent were in stable phase.
The stable phase are much dominant than bootstrapping and decay phase of Bittorrent's lifetime.
...
As example to provide estimated value of $\alpha$  and shows the fitting problem, Figure \ref{fig:fitting} shows that  for data set \emph{torrent1} and \emph{torrent3}.
