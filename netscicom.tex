...
We also study source code two popular Bittorrent clients which are uTorrent (using rasterbar libtorrent source code) and Vuze in term of peer connectivity to other client after getting random node's IP address from tracker.
