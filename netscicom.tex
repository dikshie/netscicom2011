...
In this figure, $58\%$ of the samples lie in area 3 and  $42\%$ lie in area 4, while there is no sample in areas 1 and 2, which means that the alternative model is better.
...
We believe that these results are caused by peers are not willing to maintain high degrees or load.
...
Only one torrent exhibits around  $40\%$ of clustering coefficient less than $0.1$, while for the other torrents, more than  $70\%$ are less than $0.1$.
...
Bittorrent protocol performance has been explored extensively in \cite{guo2005measurements}\cite{legout2006rarest}\cite{pouwelse2004measurement}\cite{tian2007modeling}.  
...
The huge numbers of peers sending P2P download requests to random targets on the Internet and anti-P2P companies inject bogus peers through PEX was discussed in Z.Li \textit{et al}. \cite{li2010measurement}.
