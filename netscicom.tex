...
\caption{CDF p-value of KS statistics. It shows that across our entire set of Bittorrent snapshots, around $45\%$ of the time a power-law distribution is not a good fit for the data.} 
\label{fig:cdf-p}
\vspace{-2mm}
\end{figure}
